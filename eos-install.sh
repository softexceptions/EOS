...
if ! source <(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/misc/build.func 2>/dev/null); then
    echo "Fehler: build.func nicht gefunden oder Download fehlgeschlagen!"
    exit 1
fi
